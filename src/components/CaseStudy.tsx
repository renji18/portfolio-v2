...
const MetricCard = ({ value, label }: { value: string; label: string }) => {
  return (
    <div
      ...
      "
    >
      <p className="text-myBlue text-5xl lg:text-6xl font-bold">{value}</p>

      <div className="w-12 h-[3px] bg-myBlue mx-auto mt-4 rounded-full" />

      <p className="text-lightWhite text-lg mt-4 font-semibold">{label}</p>
    </div>
  );
};
    ...
    <div className="bg-darkBlack min-h-screen text-lightWhite">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <section className="pt-32 pb-24">
          <p className="text-myBlue uppercase tracking-[0.2em] text-sm font-semibold">
            {project.category}
          </p>
          ...
          <p className="text-gray-400 text-lg lg:text-xl mt-8 max-w-4xl leading-relaxed">
            {project.tagline}
          </p>
        </section>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {project.architectureDecisions.map((item) => (
              <Card key={item.title}>
                ...
                <div className="w-16 h-[3px] bg-myBlue rounded-full mt-4 mb-5" />
        ...
        <section className="pb-24">
          <h2 className="text-4xl font-bold mb-12">Engineering Challenges</h2>
        ...
        {/* RESULTS */}
        <section className="pb-24">
          <h2 className="text-4xl font-bold mb-12">Results & Impact</h2>
        ...
        {/* LESSONS */}
        <section className="pb-24">
          <h2 className="text-4xl font-bold mb-12">Lessons Learned</h2>
