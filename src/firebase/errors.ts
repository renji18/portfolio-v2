const errors = {
  ...
  "missing-password": "A password must be provided for registration.",
  "missing-email": "An email must be provided for registration.",
...
export async function errorHandler(error: unknown) {
  ...
  return errors[errorIdentifier] ?? "Unknown error occurred";
}
